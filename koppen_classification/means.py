...
To use this script just assign path, in_netcdf1 (ts) and in_netcdf2 (pr) vars, change the yearSpan, starting year and
finishing year, in a way it works for the correct span. And the string (endString var) for the final txt files.
"""
